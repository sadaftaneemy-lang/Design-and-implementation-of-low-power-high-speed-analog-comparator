...
The figure 4 schematic represents the complete transistor-level implementation of the conventional single-tail 
dynamic comparator designed in Cadence Virtuoso Schematic Editor using 45nm CMOS technology. The 
